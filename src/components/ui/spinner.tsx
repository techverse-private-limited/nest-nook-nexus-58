...
const Default = ({ className, ...props }: SpinnerVariantProps) => (
  <LoaderIcon className={cn('animate-spin text-deep-brown', className)} {...props} />
);

const Circle = ({ className, ...props }: SpinnerVariantProps) => (
  <LoaderCircleIcon className={cn('animate-spin text-deep-brown', className)} {...props} />
);

const Pinwheel = ({ className, ...props }: SpinnerVariantProps) => (
  <LoaderPinwheelIcon className={cn('animate-spin text-deep-brown', className)} {...props} />
);
...
const CircleFilled = ({
  ...
  <div className="relative" style={{ width: size, height: size }}>
    <div className="absolute inset-0 rotate-180">
      <LoaderCircleIcon
        className={cn('animate-spin text-soft-beige opacity-20', className)}
        size={size}
        {...props}
      />
    </div>
    <LoaderCircleIcon
      className={cn('relative animate-spin text-deep-brown', className)}
      size={size}
      {...props}
    />
  </div>
...
const Ellipsis = ({ size = 24, className, ...props }: SpinnerVariantProps) => {
  return (
    <svg
      ...
      className={cn('text-deep-brown', className)}
      {...props}
    >
      <title>Loading...</title>
...
export const Spinner = ({ variant, className, ...props }: SpinnerProps) => {
  switch (variant) {
    ...
    case 'bars':
      return <Bars className={className} {...props} />;
    case 'infinite':
      return <Infinite className={className} {...props} />;
    default:
